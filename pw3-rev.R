...
# Cambiamos los nombres de las columnas de los data frames para hacer las gráficas más amigables
...
data.games.heatmap <- ggplot(games.cprob.df, aes(x=goles_casa, y=goles_afuera, fill=prob_marginal)) + 
  geom_tile() +
  xlab("Goles en casa") +
