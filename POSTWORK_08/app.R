## app.R ##
# Necesitará instalar las siguientes librerias
# "shiny", "shinydashboard", "shinythemes", "ggplot2", "plotly", "dplyr", "tidyr", "ggfortify", 
# "autoplotly", "zoo", "ggthemes", "fbRanks", "DT", "dashboardthemes", "fbranks", "devtools"
...
# Obtenemos y formateamos los datos que necesitaremos
...
ui <- 
    ...
    dashboardPage(title="Dashboard de match.games | BEDU",
            ...
            dashboardSidebar(
                ...
                # Creamos nuestros botones en el sidebar
                sidebarMenu(
            ...
            dashboardBody(
                customTheme, # Implementamos nuestro tema personalizado y agregamos el título
                ...
                tabItems(
                    ...
                    # Creamos los tabs para las gráficas que necesitamos
...
server <- function(input, output) {
    # Gráfica de barras goles visitante y local
